...
<img width="1881" height="874" alt="image" src="https://github.com/user-attachments/assets/6fb92c76-ddd7-4a07-8bfc-538698729e55" />
...
<img  width="1400" height="300" alt="image" src="https://github.com/user-attachments/assets/c15620d7-814a-4d87-9340-dbe88840015b" />
...
<div align="center">
  <img src="assets/snap1.png" width="30%" style="margin:10px"/>
  <img src="assets/snap2.png" width="30%" style="margin:10px"/>
  <img src="assets/snap3.png" width="30%" style="margin:10px"/>
</div>
...
```mermaid
graph TD;
    A[User Landing Page] --> B{Login / Signup}
    B --> C[Dashboard]
    C --> D[Track Period]
    C --> E[Add Mood & Symptoms]
    C --> F[Cycle Analytics]
    C --> G[Health Tips]
    C --> H[Settings / Logout]
...
<img width="1444" src="https://capsule-render.vercel.app/api?type=waving&color=ff70a6&height=120&section=footer"/>
